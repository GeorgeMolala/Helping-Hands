...
namespace Helping_Hands.Areas.Patient.Controllers
{
    ...
    [Area("Patient")]
    public class CareVisitsController : Controller
    {
        private HelpingHandsUnitOfWork data { get; set; }
        public CareVisitsController(GRP0452HelpingHandsDBContext ctx) => data = new HelpingHandsUnitOfWork(ctx);
